...
Most smart devices today have some kind of input method to aid blind users or users with impaired vision. The VoiceOver solution reads the selected virtual key out loud. The user then selects the key by double tapping that postition on the display\cite{voiceover}.\todo{Jag vill ta bort detta stycke /B}
