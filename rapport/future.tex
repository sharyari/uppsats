...
Since the early 1990's there has been a lot of research on Brain-Computer Interaction (BCI) systems. These systems uses brain reading techniques to use brain activity as input to a computer. \todo{skriv mer. kan vara värt att läsa HowStuffWorks.com-artikeln om BCI}
